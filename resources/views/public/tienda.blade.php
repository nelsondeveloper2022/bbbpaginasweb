                            ...
                            <div class="product-card">
                                ...
                                <div class="product-body product-clickable" 
                                    ...
                                    <div class="product-footer">
                                        ...
                                        @else
                                            <a href="https://wa.me/57{{ $empresa->whatsapp ?? $empresa->movil }}?text=Hola%20{{ urlencode($empresa->nombre) }}!%20Estoy%20interesado%20en%20el%20producto:%20{{ urlencode($producto->nombre) }}%20¿Podrías%20darme%20más%20información?" 
                                               class="btn-comprar" 
                                               target="_blank"
                                               onclick="event.stopPropagation();">
