...
@section('title')
{{ __('plans.payment_error_title') }} - BBB Páginas Web
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <div class="payment-result-card error">
                    ...
                    <h1 class="title">{{ __('plans.payment_error_title') }}</h1>
                    <p class="subtitle">{{ __('plans.payment_error_message') }}</p>
                    ...
                    <div class="actions">
                        <a href="{{ route('checkout.show', ['locale' => app()->getLocale(), 'planSlug' => $carrito->bbbPlan->slug ?? 'basic']) }}" class="btn btn-primary">
                            {{ __('plans.try_again') }}
                        </a>
...
.payment-result-card.error .icon-container {
